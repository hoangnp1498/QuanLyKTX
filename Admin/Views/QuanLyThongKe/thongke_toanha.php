                ...
                <div class="col-xs-12 col-sm-8 col-md-10 col-lg-10 benphai">
                    <div class="container-fluid" style="padding: 0px;">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 chutieude">
                                <h2>Quản lý thông kê Tòa Nhà</h2>
                            </div>
                        </div>
                        <hr class="ngay_ad">
                    </div>
                    <div class="container-fluid">
                        <div class="row">
                            <!-- nho doi ten class -->
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div id="dulieu_toa_nha_"><?php include './Modules/QuanLyThongKe/dulieu_thongke_toa_nha.php';
                                                            //include './../dulieu/dulieu_thongke_toa_nha.php'; 
                                                            ?></div>
                            </div>
