...
include './Modules/Check_login/check_admin.php;'
                ...
                <div class="col-xs-12 col-sm-8 col-md-10 col-lg-10 benphai">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <!-- nho doi ten class -->
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div id="dulieucochucvu"><?php include './Modules/QuanLyCanBo/dulieucochucvu.php';
                                //include './../dulieu/dulieucochucvu.php'; ?></div>
                            </div>
