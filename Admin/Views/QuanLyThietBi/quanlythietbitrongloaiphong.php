                ...
                <div class="col-xs-12 col-sm-8 col-md-10 col-lg-10 benphai">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <!-- nho doi ten class -->
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div id="dulieuthietbitrongloaiphong"><?php include './Modules/QuanLyThietBi/dulieuthietbitrongloaiphong.php';
                                //include './../dulieu/dulieuthietbitrongloaiphong.php'; ?></div>
                            </div>
