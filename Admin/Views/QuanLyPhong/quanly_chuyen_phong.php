            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-10 col-lg-10 benphai">
                    ...
                    <div class="container-fluid  ">
                        ...
                        <div class="row">
                            <!-- nho doi ten class -->
                            <div class="dulieu_log_edit_lop" id="dlchuyenphong" style="width: 100%; font-size: 14px;">
                            <?php include './Modules/QuanLyPhong/dulieu_log_edit_chuyen_phong.php';
                            //include './../dulieu/dulieu_log_edit_chuyen_phong.php'; ?></div>
                        </div><!-- end thaydoi1 -->
