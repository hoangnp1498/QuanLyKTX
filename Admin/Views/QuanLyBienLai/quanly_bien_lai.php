        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-10 col-lg-10 benphai">
                    ...
                    <hr class="ngay_ad">
                    <form action="./../../../Modules/Excel/xuat_excel_bienlai.php" id="" method="POST" role="form">
                    ...
                    <div class="row">
                        <!-- nho doi ten class -->
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div id="dulieu_o_phong"><?php include './Modules/QuanLyBienLai/dulieu_bien_lai.php';
                                                        //'./../dulieu/dulieu_bien_lai.php'; 
                                                        ?></div>
                        </div>
