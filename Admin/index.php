					...
					<div class="container-fluid">
						<div class="row">
							...
							if ($qr_ktra_chucvu['idchucvu'] == 0) { ?>
								<a href="quanlycanbo.php" title="">
									<!--  hien thoong trinh chi tiet Cán bộ-->
							...
							<?php } ?>
							<a href="quanly_o_phong.php" title="">
								<!--  hien thoong trinh chi tiet Tòa nhà-->
								<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							...
							<a href="quanlyquatrinhophong_sinhvien.php" title="">
								<!--  hien thoong trinh chi tiet Tòa nhà-->
								<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							...
							<a href="quanlyphong.php" title="">
								<!--  hien thoong trinh chi tiet Phòng-->
								<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							...
							<a href="quanlyloaiphong.php" title="">
								<!--  hien thoong trinh chi tiet Loại phòng-->
								<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							...
							<a href="quanlykhoa.php" title="">
								<!--  hien thoong trinh chi tiet khoa -->
								<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
							...
							<a href="quanlysinhvien.php" title="">
								<!--  hien thoong trinh chi tiet Sinh viên-->
								<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
									<div class="thumbnail mua_nen_7">
										<div class="captionb align-middler">
							...
							<a href="quanlythietbi.php" title="">
