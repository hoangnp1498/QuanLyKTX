			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-8 col-md-10 col-lg-10 benphai">
					<div class="container-fluid " style="padding: 0px;">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 chutieude">
								<h2>Lịch sử Xóa dữ liệu quản lý Thiết bị</h2>
							</div>
						</div>
						<hr class="ngay_ad">
					</div>
					<div class="container-fluid  ">
						<div class="row">
							<!-- nho doi ten class -->
							<div class="dulieu_log_delete_thietbi" style="width: 100%; font-size: 14px;"><?php include './../dulieu/dulieu_log_delete_thietbi_1.php'; ?></div>
						</div><!-- end thaydoi1 -->
