...
<head>
	...
	<script type="text/javascript" src="../js/js_quanlysinhvien_cua_lop.js"></script>
				...
				<div class="col-xs-12 col-sm-8 col-md-10 col-lg-10 benphai">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 chutieude">
								<h2>Danh sách sinh viên Lớp: <span class="chuinhoa">
										<?php
										$lop = mysqli_fetch_array(mysqli_query($con, "SELECT lop.ma_lop FROM lop WHERE lop.xoa =0 AND lop.id_lop ='$_GET[lop]'"));
										echo $lop1 = $lop["ma_lop"]; ?>
									</span>
								</h2>
							</div>
						</div>
					...
					<div class="container-fluid">
						<div class="row">
							<!-- nho doi ten class -->
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div id="dulieu_dssinhviencualop"><?php include './../dulieu/dulieu_dssinhviencualop.php'; ?></div>
							</div>
