					...
					<div class="container-fluid " style="padding: 0px;">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 chutieude">
								<h2>Lịch sử thay dữ liệu Chuyển phòng</h2>
							</div>
						</div>
					<hr class="ngay_ad"></div>
					<div class="container-fluid  ">
						<div class="row"><!-- nho doi ten class -->
						<div class="dulieu_log_edit_lop" style="width: 100%; font-size: 14px;"><?php include './../dulieu/dulieu_log_edit_chuyen_phong.php'; ?></div>
						</div><!-- end thaydoi1 -->
