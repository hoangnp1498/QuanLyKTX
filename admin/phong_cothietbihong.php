				...
				<div class="col-xs-12 col-sm-8 col-md-10 col-lg-10 benphai">
					<div class="container-fluid" style="padding: 0px;">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 chutieude">
								<h2>Quản lý thiết bị phòng hỏng</h2>
							</div>
						</div>
						<hr class="ngay_ad">
					</div>
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div id="dulieuphong">
									<?php include './../dulieu/dulieu_thitbi_phonghong.php'; ?>
								</div>
							</div>
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
								<form action="./../dulieu/xuat_excel_thibhong.php" method="POST" role="form">
									<button type="submit" class="btn btn-primary" name="xuat_excel_thibhong">Xuất Excel</button>
								</form>
							</div>
						</div><!-- end thaydoi1 -->
