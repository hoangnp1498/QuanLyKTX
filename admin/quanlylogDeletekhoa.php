					...
					<div class="container-fluid " style="padding: 0px;">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 chutieude">
								<h2>Lịch sử Xóa dữ liệu quản lý Khoa</h2>
							</div>
						</div>
					<hr class="ngay_ad"></div>
					<div class="container-fluid  ">
						<div class="row"><!-- nho doi ten class -->
						<div class="dulieu_log_delete_khoa" style="width: 100%; font-size: 14px;"><?php include './../dulieu/dulieu_log_delete_khoa_1.php'; ?></div>
						</div><!-- end thaydoi1 -->
